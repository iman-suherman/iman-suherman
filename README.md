...
Outside day jobs, I build and ship products on [suherman.net](https://suherman.net) — platforms, macOS and mobile apps, developer tools, and local AI gateways — with signed releases, registry APIs, and Cloudflare-backed distribution. Full experience and achievements: [iman.suherman.net](https://iman.suherman.net/).
...
- **[LinuxLens](https://linuxlens.suherman.net/)** Vendor-neutral Linux estate risk assessment — lifecycle, patch lag, security exposure, and operational constraints with capability-first remediation. Open-source collect/assess CLI and offline mode for regulated estates ([GitHub](https://github.com/LinuxLens)).
